  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background p-6">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 rounded-[28px] border border-border bg-card/95 p-8 text-center shadow-[0_18px_60px_rgba(23,32,51,0.08)] backdrop-blur">
          <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-accent/10 text-accent">
            <MailCheck className="h-6 w-6" />
          </div>

          <h1 className="mt-5 text-2xl font-bold tracking-tight text-foreground dark:text-white">
            Check your email
          </h1>
          ...
          <Link
            ...
            className="mt-6 inline-flex h-12 w-full items-center justify-center rounded-2xl bg-primary-surface text-sm font-semibold text-white"
          >
            Back to login
          </Link>
        </div>
